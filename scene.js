...
export async function createScene({ onThemeChange } = {}) {
  ...
  const images = await Promise.allSettled(
    [
      ...
      "canopy-night-v2.png",
      "angsana-flower.png",
      "ceramics-gallery-interior-v2.png",
