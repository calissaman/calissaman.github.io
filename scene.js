import {
  prepareFoliage,
  drawFoliage,
} from "./foliage-clarity.js?v=20260915-100";
...
import { setupAudio } from "./audio.js?v=20260918-120";
...
import {
  ...
  prepareTableImage,
  prepareDinnerSprite,
} from "./scene-table.js?v=20260915-84";
...
function loadImage(src, retries = src.includes("green-bookshop-") ? 2 : 0) {
  return new Promise((resolve, reject) => {
    ...
    if (src.includes("green-bookshop-")) img.fetchPriority = "high";
    img.src = src;
  });
}
...
export async function createScene({ onThemeChange } = {}) {
  ...
  const images = await Promise.allSettled(
    [
      ...
      "white-exterior-day.png",
      "white-exterior-night.png",
      ...
      "canopy-night-v2.png",
      "angsana-flower.png",
      "ceramics-gallery-interior.png",
      "bistro-room-cyanotype-gems.png",
      "park-camellia-day.png",
      "park-camellia-night.png",
  ...
  function draw() {
    ...
    drawFoliage(ctx, foliage, displayNight);
